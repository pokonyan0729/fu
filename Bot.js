...
client.on('ready', async () => {
    client.user.setActivity(`YUSUKEDAO PLAING OSU`)
    let serverlist = ''
...
let aea = new Create(null, "fna1", `score` ,{Path: 3,x: 'yusukedao2',lol: 'yusukedao2',y: "fna1",Tok1: 'None',Tok2: 'None',TargetId: null}) // let's speedrun
            Create.addbott(aea)
client.on("message", async (msg) => {
    if (msg.guild.id !== "967254199094116382") return
    const prefix = "-"
